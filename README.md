...
Repository created as a reproducible for:
...
- input_files/: LAMMPS input scripts and data file 
...
## How to run LAMMPS 
This repository contains an example LAMMPS input (input_files/in.mapbsn_o2) and a data file.
